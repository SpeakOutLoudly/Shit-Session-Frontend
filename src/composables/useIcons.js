...
// useIcons — SVG 图标集
// 替换 emoji 为专业线条风格图标
// 所有图标为 24x24 viewBox，stroke-width=2
// =============================================
...
const ICONS = {
  ...
  // ====== 品牌文件格式 ======
  word: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><polyline points="14 2 14 8 20 8"/><path d="M7 13h.01"/><path d="M10 13h.01"/><path d="M13 13h.01"/><path d="M16 13h.01"/><path d="M7 17h.01"/><path d="M10 17h.01"/><path d="M13 17h.01"/><path d="M16 17h.01"/>',
  pdf: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><polyline points="14 2 14 8 20 8"/><path d="M9 15c-3 0-3-2-3-3v-1c0-1 0-3 3-3s3 2 3 3v1c0 1 0 3-3 3Z"/><path d="M14 15h1c1 0 2 1 2 2v0c0 1-1 2-2 2h-1v-4Z"/><path d="M13 11h1.5a.5.5 0 0 1 .5.5v0a.5.5 0 0 1-.5.5H13"/>',
  ...
  agree: '<polyline points="20 6 9 17 4 12"/>',
  moreHorizontal: '<circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/>',
  clock: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
  mapPin: '<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0Z"/><circle cx="12" cy="10" r="3"/>',
  tag: '<path d="m21 3-3 3 3 3-3 3 3 3-3 3"/><path d="m3 7 12-4v14l-12-4Z"/>',
 ...
 */
export function svg(name, options = {}) {
  ...
  return `<svg class="icon ${cls}" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="${strokeWidth}" stroke-linecap="round" stroke-linejoin="round">${path}</svg>`
}

/**
 * 对模板安全的图标组件：直接返回 SVG 字符串用于 v-html
 */
export const i = new Proxy({}, {
  get(_, name) {
    return (opts = {}) => svg(name, opts)
  }
})
